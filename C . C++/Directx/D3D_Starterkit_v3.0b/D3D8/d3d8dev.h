...
interface hkIDirect3DDevice8;
class CD3DManager
{
public:
	CD3DManager(IDirect3DDevice8 *pD3Ddev, hkIDirect3DDevice8 *pParent)
	{
		m_pParent = pParent;
		m_pD3Ddev = pD3Ddev;
	}
...
private:
	hkIDirect3DDevice8	*m_pParent;
	IDirect3DDevice8	*m_pD3Ddev;	
};



interface hkIDirect3DDevice8 : public IDirect3DDevice8
{
public:
	hkIDirect3DDevice8(IDirect3DDevice8 **ppReturnedDeviceInterface, D3DPRESENT_PARAMETERS *pPresentParam, IDirect3D8 *pIDirect3D8)
	{
